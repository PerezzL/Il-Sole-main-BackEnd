...
// Se borra apenas se corre la migracion de la tabla Notificacion.
app.post('/api/_migrate_notificacion', async (req, res) => {
  ...
  try {
    ...
    const sql = fs.readFileSync(path.join(__dirname, 'database', 'add_notificacion_table.sql'), 'utf8');
